...
export const input = `border rounded py-2 pr-4 mr-2 shadow-sm focus:ring-1 focus:outline-none focus:border-green-500 focus:ring-green-500`;
export const searchWrap = `w-80 pl-10 bg-[10px] bg-[url('/magnifying-glass-solid.svg')] bg-no-repeat flex ${input}`;
export const headerBtnBlock = "flex justify-between";
