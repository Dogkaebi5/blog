...
function test(t) {
  ...
  if (tag.startWith("Q"))
    return `<blockquote className="border-l-8 pl-4 my-2"><pre dangerouslySetInnerHTML={{ __html: ${t} }} /></blockquote>`;
  if (tag.startWith("FN"))
    return `<Link id={fnr-${t}} href={#fn-${t}}><sup className=" text-blue-600">[${c}]</sup></Link>`;
